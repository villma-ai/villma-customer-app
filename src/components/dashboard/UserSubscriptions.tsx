...
import SubscriptionSettingsDialog from '@/components/ui/SubscriptionSettingsDialog';
...
export default function UserSubscriptions({ userId }: UserSubscriptionsProps) {
  ...
  const handleOpenSettings = (subscription: UserSubscription) => {
        ...
        {subscriptions.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {subscriptions.map((subscription) => (
              <div
                key={subscription.id}
                className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 hover:shadow-2xl transition duration-300 max-w-md mx-auto w-full"
              >
                <div className="px-6 py-4 bg-gradient-to-r from-sky-500 to-indigo-600">
                  <div className="flex justify-between items-start">
                    ...
                    <button
                      ...
                      className="text-white hover:text-sky-200 transition-colors p-1 cursor-pointer"
                      title="Settings"
                    >
                      <svg
                        className="w-5 h-5"
