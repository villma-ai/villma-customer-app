...
export function validateEnvironmentVariables(): void {
  ...
  if (missingVars.length > 0 || emptyVars.length > 0) {
    ...
    console.error('FIREBASE_AUTH_DOMAIN=your_project.firebaseapp.com');
    console.error('FIREBASE_PROJECT_ID=your_project_id');
    console.error('FIREBASE_STORAGE_BUCKET=your_project.appspot.com');
    console.error('FIREBASE_MESSAGING_SENDER_ID=123456789');
    console.error('FIREBASE_APP_ID=1:123456789:web:abcdef');
